...
cp %{_builddir}/Sort-Naturally-1.03/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Sort-Naturally/eadfab6cc46a0e4abf06e9b5bf97414647a794b7
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Sort/Naturally.pm
