...
cd ..
%setup -q -T -D -n Sort-Naturally-1.03 -b 1
mkdir -p deblicense/
...
cp deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Sort-Naturally/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.0/Sort/Naturally.pm
...
/usr/share/package-licenses/perl-Sort-Naturally/deblicense_copyright
